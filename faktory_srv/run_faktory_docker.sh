...
docker run -d --rm -it -v faktory-data:/var/lib/faktory -e "FAKTORY_PASSWORD=some_password" -p 127.0.0.1:$1:$1 -p 127.0.0.1:$2:$2 contribsys/faktory:latest /faktory -b :$1 -w :$2 -e production tail -f /dev/null
