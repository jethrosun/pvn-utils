...
def p2p_sess_setup(node, trace, nf, setup):
    ...
    try:
        ...
        p2p_sess.send_commands('cd /home/jethros/dev/pvn/utils/bt_srv')
...
def run_p2p_nodes(sess, trace, nf, epoch, setup, port1, port2, expr_num):
    cmd_str = "sudo ./run_netbricks_app.sh " + trace + " " + nf + " " + str(
